  ...
  return (
    <div className="container mx-auto">
      ...
      {['title', 'type', 'img'].map((field) => (
        <div key={field} className="flex justify-center mb-4">
          <fieldset className="fieldset w-96">
            <legend className="fieldset-legend">Book {field.charAt(0).toUpperCase() + field.slice(1)}:</legend>
            <input
              type="text"
      ...
      <div className="flex justify-center gap-4 mt-6">
        <button type="button" className="btn btn-outline btn-primary" onClick={handleSubmit}>Update</button>
